      ...
      {raceData && trackData ? (
        <div className={classes.main}>
          ...
          <div className={classes.trackData}>
            <Card className={classes.raceImgCard}>
              <img src={raceData.img} alt="race" className={classes.raceImg}/>
            </Card>
            <Card>
              <CardBody>
              <h5>
              ...
              <h5>
                <span>Max perticipants:</span> <br />
                {raceData.availability}
              </h5>
              <h5>
                <span>Race length:</span> <br />
                {raceData.raceLengthMinutes / 60} Hours
              </h5>
              <h5>
                <span>Race date:</span> <br />{" "}
                {moment(raceData.raceDate.toDate(), "en").format("LLLL, UTCZZ")}{" "}
